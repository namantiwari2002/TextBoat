const submitReview = (e) => {
    ...
    fetch('/sentiments/api/nlp/s-analyzer', options)
      .then(res => res.json())
      .then (({ analysis }) => {
       
        if (analysis < 0) {
          emojiSection.innerHTML = '<img src="https://img.icons8.com/officel/100/000000/angry.png">';
          title.style.color = 'red';
          outline.style.borderColor = 'red';
          console.log(analysis*10);
        };
        ...
        if (analysis > 0) {
          emojiSection.innerHTML = '<img src="https://img.icons8.com/office/100/000000/happy--v1.png">';
